...
import { EquivalentType } from '@/types';
...
export const EquivalentPeriodInfo = ({
  onOpen,
  items,
}: EquivalentPeriodInfoProps) => {
  return (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium">
                  {`${NUTRITIONAL_ABBREVIATIONS[item.request.gs]}`}
                </p>
                <p className="text-sm text-muted-foreground">
                  Click para ver equivalentes
                </p>
              </div>
            </div>
