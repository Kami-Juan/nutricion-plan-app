import { Badge, Button, Card, CardContent, CardFooter, CardHeader, CardTitle } from "@k-health/ui";
  ...
  return (
    <Card className="w-full mb-4 hover:shadow-lg transition-shadow">
      ...
      <CardContent className="p-6">
        <p className="text-sm font-medium text-muted-foreground mb-4">Ingredientes</p>
        <div className="pr-4">
