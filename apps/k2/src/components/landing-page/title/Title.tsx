  ...
  return (
    <>
      <div className="hidden md:flex items-center justify-center gap-3 mb-8">
        ...
        <h1 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-primary to-primary/60">
          Plan Nutricional
        </h1>
      </div>
      <h1 className="md:hidden text-2xl font-bold mb-4 bg-clip-text text-transparent bg-linear-to-r from-primary to-primary/60">
        Plan Nutricional
      </h1>
